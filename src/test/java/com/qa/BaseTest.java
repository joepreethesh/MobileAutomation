...
public class BaseTest {
	...
	public synchronized void afterMethod(ITestResult result) throws Exception {
		...
		Map <String, String> params = result.getTestContext().getCurrentXmlTest().getAllParameters(); // get data from testng.xml file
...
//				.withArgument(() -> "--allow-insecure","chromedriver_autodownload")
  ...
  public void beforeTest(@Optional("androidOnly")String emulator, String platformName, String udid, String deviceName, 
		  @Optional("androidOnly")int systemPort, @Optional("androidOnly")String chromeDriverPort,
	  ...
	  try {
		  ...
		  setStrings(utils.parseStringXML(stringsis));
			...
			url = new URL(props.getProperty("appiumURL"));
		  	...
		  	String appPath =  new File(appUrl.toURI()).getAbsolutePath();
			...
			case "Android":
				UiAutomator2Options options = new UiAutomator2Options().
						...
						setUnlockType("pin"). //password, pattern, fingerprint only in emulator
								setUnlockKey("29301304").
						setSystemPort(systemPort).
						setUdid(udid);
				options.setCapability("chromeDriverPort", chromeDriverPort);
				//options.setCapability("browserName", "Chrome");
				//options.setCapability("includeSafariInWebviews", true); for ios
				//ios-deploy -c to get the udid of iOS device
